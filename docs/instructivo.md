# 3. Instructivo Detallado

### Desarrolla una propuesta de instructivo detallada con los pasos para desarrollar el instalador de software seleccionado para plasmar un registro formal sobre el procedimiento del mismo.

A continuación, se presenta el instructivo formal para la creación del instalador del sistema "Santiago Seguros Analytics" utilizando la herramienta **Inno Setup**. Este documento servirá como guía de referencia para el equipo de desarrollo y como registro del procedimiento técnico seguido.
